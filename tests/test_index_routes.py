...
@pytest.mark.usefixtures("indexes_sample")
async def test_delete_index(fastapi_test_client, index_uid, index_uid2, async_meilisearch_client):
...
@pytest.mark.usefixtures("indexes_sample")
async def test_update_index(fastapi_test_client, index_uid, async_meilisearch_client):
    primay_key = "objectID"
...
async def test_update_ranking_rules(
    fastapi_test_client, async_empty_index, new_ranking_rules, async_meilisearch_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_distinct_attribute(
    fastapi_test_client, async_empty_index, new_distinct_attribute, async_meilisearch_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_searchable_attributes(
    fastapi_test_client, async_empty_index, new_searchable_attributes, async_meilisearch_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_displayed_attributes(
    fastapi_test_client, async_empty_index, displayed_attributes, async_meilisearch_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_stop_words(
    fastapi_test_client, async_empty_index, new_stop_words, async_meilisearch_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_synonyms(
    fastapi_test_client, async_empty_index, new_synonyms, async_meilisearch_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_faceting(
    fastapi_test_client, async_empty_index, faceting, async_meilisearch_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_filterable_attributes(
    fastapi_test_client, async_empty_index, filterable_attributes, async_meilisearch_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_sortable_attributes(
    fastapi_test_client, async_empty_index, sortable_attributes, async_meilisearch_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_typo_tolerance(
    fastapi_test_client, async_empty_index, new_typo_tolerance, async_meilisearch_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
