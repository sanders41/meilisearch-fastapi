...
async def test_get_stats(fastapi_test_client, async_empty_index, small_movies, async_client):
    uid = str(uuid4())
...
async def test_update_ranking_rules(
    fastapi_test_client, async_empty_index, new_ranking_rules, async_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_reset_ranking_rules(
    fastapi_test_client, async_empty_index, new_ranking_rules, default_ranking_rules, async_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
    data = {"uid": uid, "rankingRules": new_ranking_rules}
...
async def test_update_distinct_attribute(
    fastapi_test_client, async_empty_index, new_distinct_attribute, async_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_reset_distinct_attribute(
    fastapi_test_client,
    async_empty_index,
    new_distinct_attribute,
    default_distinct_attribute,
    async_client,
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_get_searchable_attributes(
...
async def test_update_searchable_attributes(
    fastapi_test_client, async_empty_index, new_searchable_attributes, async_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_get_displayed_attributes(
    fastapi_test_client, async_empty_index, small_movies, async_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_displayed_attributes(
    fastapi_test_client, async_empty_index, displayed_attributes, async_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_stop_words(
    fastapi_test_client, async_empty_index, new_stop_words, async_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_reset_stop_words(
    fastapi_test_client, async_empty_index, new_stop_words, async_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_synonyms(fastapi_test_client, async_empty_index, new_synonyms, async_client):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_reset_synonyms(fastapi_test_client, async_empty_index, new_synonyms, async_client):
    uid = str(uuid4())
    await async_empty_index(uid)
    data = {"uid": uid, "synonyms": new_synonyms}
    response = await fastapi_test_client.patch("/indexes/synonyms", json=data)
...
async def test_update_faceting(fastapi_test_client, async_empty_index, faceting, async_client):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_reset_faceting(fastapi_test_client, async_empty_index, faceting, async_client):
    uid = str(uuid4())
    await async_empty_index(uid)
    ...
    await async_client.wait_for_task(response.json()["taskUid"])
    response = await fastapi_test_client.get(f"/indexes/faceting/{uid}")
    assert response.json() == {"maxValuesPerFacet": 100, "sortFacetValuesBy": {"*": "alpha"}}
...
async def test_update_filterable_attributes(
    fastapi_test_client, async_empty_index, filterable_attributes, async_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_sortable_attributes(
    fastapi_test_client, async_empty_index, sortable_attributes, async_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_update_typo_tolerance(
    fastapi_test_client, async_empty_index, new_typo_tolerance, async_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
...
async def test_reset_typo_tolerance(
    fastapi_test_client, async_empty_index, new_typo_tolerance, async_client
):
    uid = str(uuid4())
    await async_empty_index(uid)
